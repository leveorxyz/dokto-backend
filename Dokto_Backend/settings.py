...
FLUTTERWAY_PUBLIC_KEY = os.getenv(
    "FLUTTERWAY_PUBLIC_KEY", "FLWPUBK_TEST-cef158ec1b1213690fbeeccb930be993-X"
)
FLUTTERWAY_SECRET_KEY = os.getenv(
    "FLUTTERWAY_SECRET_KEY", "FLWSECK_TEST-623211fbda02200d0d3b8904bdd27088-X"
)
FLUTTERWAY_ENCRYPTION_KEY = os.getenv(
    "FLUTTERWAY_ENCRYPTION_KEY", "FLWSECK_TEST6207416b757f"
)
